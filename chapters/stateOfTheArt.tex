...
Previous bandwidth usage shown per each SDI standard are given by specific parameters which are defined by the uncompressed transmitted media type. Which are:
...
Since current and non-IP-converged transport technologies have been briefly introduced next chapteris focusing on IP convergence in a tranport and media point of view.
