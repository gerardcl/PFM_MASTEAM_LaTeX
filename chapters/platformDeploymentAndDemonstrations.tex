  ...
  \begin{center}
    \begin{subfigmatrix}{2}
      \subfigure[Audio paths]
         {\includegraphics{./images/testAVMix/AVMixAudioAVGdelay.png}\label{SF:S1}} 
      \subfigure[Video paths]
         {\includegraphics{./images/testAVMix/AVMixVideoAVGdelay.png}\label{SF:S2}} 
    \end{subfigmatrix}
...
So, the average delay introduced for the audio "receiver to mixer" paths averages is about 8,6 milliseconds and the audio "mixer to transmitter" path average delay is about 23.1 milliseconds, which gives a total average value of 31,7 milliseconds of average processing time regarding the audio pipeline. Then, regarding the same calculus but about the video pipeline path's, an average of 9,89 milliseconds is obtained by averaging the "receiver to mixer" video paths average processing times. And, by adding the average of the "mixer to transmitter" path processing time of 318,6 milliseconds a total average of 328,49 milliseconds of delay introduced for the video pipeline is obtained.

\begin{figure}[!htb]
  \begin{center}
    \begin{subfigmatrix}{2}
      \subfigure[Audio paths]
         {\includegraphics{./images/testAVMix/AVMixAudioLostBlocs.png}\label{SF:S1}} 
      \subfigure[Video paths]
         {\includegraphics{./images/testAVMix/AVMixVideoLostBlocs.png}\label{SF:S2}} 
    \end{subfigmatrix}
