...
Although the huge amount of issues to be solved, this project will only be focused on those related to cloud migration for real-time media production at application plane. Specifically, these are:
